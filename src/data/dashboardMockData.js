...
export const projectenData = {
  ...
  chartCategories: [
    { label: "Definitieve aanvraag", percentage: 35, color: "#312e81" },
    { label: "Pré aanvraag", percentage: 20, color: "#4f46e5" },
    { label: "Natuur", percentage: 15, color: "#818cf8" },
    { label: "Onderwijs", percentage: 12, color: "#14b8a6" },
    { label: "Culturele projecten", percentage: 10, color: "#2dd4bf" },
    { label: "Projecten", percentage: 8, color: "#f59e0b" },
  ],
  budget: "€ 2.950.000,00",
  toegekend: "€ 33.784,56",
