...
const mod = modules.find((m) => m.id === "meeting-module");
const otherModules = modules.filter((m) => m.id !== "meeting-module");

export default function SolutionMeetingModule() {
  return (
    <PageTransition>
      {/* Hero */}
      ...
      <SectionWrapper bg="white">
        <SectionHeading
          ...
          title="Digitaal vergaderen, eenvoudig en veilig"
        />
      ...
      <FAQAccordion
        ...
        title="Veelgestelde vragen vergadermodule"
        items={mod.faq}
      />
