...
const mod = modules.find((m) => m.id === "relationship-management");
const otherModules = modules.filter((m) => m.id !== "relationship-management");

export default function SolutionRelationshipMgmt() {
  return (
    <PageTransition>
      {/* Hero */}
